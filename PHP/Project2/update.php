<?php
	$msg="";
		...
		{	
			...
			{
				$name = $_POST['name'];
				$q = "update test SET name='$name' where id=$id";
			...
			{
				$id = $_POST['id'];
				$q = "update test SET id='$id' where id=$id";
				$rs = mysqli_query($con,$q);
				if($rs)
				{
					$msg="Recored is updated";
			...
			elseif(isset($_POST['Password1']))
			{
				...
				$q = "update test SET password='$password' where id=$id";
				$rs = mysqli_query($con,$q);
				if($rs)
				{
					$msg="Recored is updated";
			...
			{
				$email = $_POST['email'];
				$q = "update test SET email='$email' where id=$id";
				$rs = mysqli_query($con,$q);
				if($rs)
				{
					$msg="Recored is updated";
			...
			{
				$dob = $_POST['dob'];
				$q = "update test SET dob='$dob' where id=$id";
				$rs = mysqli_query($con,$q);
				if($rs)
				{
					$msg="Recored is updated";
			...
			{
				$gender = $_POST['gender'];
				$q = "update test SET gender='$gender' where id=$id";
				$rs = mysqli_query($con,$q);
				if($rs)
				{
					$msg="Recored is updated";
			...
			elseif(isset($_POST['hobby1']))
			{
				...
				$q = "update test SET hobbies='$hobbies' where id=$id";
				$rs = mysqli_query($con,$q);
				if($rs)
				{
					$msg="Recored is updated";
			...
			elseif(isset($_POST['language1']))
			{
				...
				$q = "update test SET language='$Language' where id=$id";
				$rs = mysqli_query($con,$q);
				if($rs)
				{
					$msg="Recored is updated";
			...
			{
				$story = $_POST['story'];
				$q = "update test SET story='$story' where id=$id";
				$rs = mysqli_query($con,$q);
				if($rs)
				{
					$msg="Recored is updated";
