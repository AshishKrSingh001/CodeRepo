<?php
    ...
    $query = "SELECT * FROM hues WHERE name LIKE '%$search%' order by id DESC LIMIT $start_from, $record_per_page";
...
<body>
    ...
    <div class="main">
            ...
            <?php
                $page_query = "SELECT * FROM hues ORDER BY id DESC";
                ...
                if($page > 1)
                {
                    echo "<a class='a' href='main.php?page=1'>First</a>";
                    echo "<a class='a' href='main.php?page=".($page - 1)."'>Previous</a>";
                }
                for($i=$start_loop; $i<=$end_loop; $i++)
                {     
                    echo "<a class='a' href='main.php?page=".$i."'>".$i."</a>";
                }
                if($page < $end_loop)
                {
                    echo "<a class='a' href='main.php?page=".($page + 1)."'>Next</a>";
                    echo "<a class='a' href='main.php?page=".$total_pages."'>Last</a>";
                }
            ?>
        </div>
    </div>
