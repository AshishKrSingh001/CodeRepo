<?php
    ...
    $query = "SELECT * FROM hues where category='bollywood' order by id DESC LIMIT $start_from, $record_per_page";
    ...
    <div class="main">
        ...
        <div class="php" align="center">
            <?php
                ...
                if($page > 1)
                {
                    echo "<a class='a' href='bolly.php?page=1'>First</a>";
                    echo "<a class='a' href='bolly.php?page=".($page - 1)."'>Previous</a>";
                }
                for($i=$start_loop; $i<=$end_loop; $i++)
                {     
                    echo "<a class='a' href='bolly.php?page=".$i."'>".$i."</a>";
                }
                if($page < $end_loop)
                {
                    echo "<a class='a' href='bolly.php?page=".($page + 1)."'>Next</a>";
                    echo "<a class='a' href='bolly.php?page=".$total_pages."'>Last</a>";
                }
            ?>
        </div>
    </div>
