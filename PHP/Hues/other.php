<?php
    ...
    $query = "SELECT * FROM hues where category='other' order by id DESC LIMIT $start_from, $record_per_page";
...
<body>
    ...
    <div class="main">
        ...
        <div class="php" align="center">
            <?php
                $page_query = "SELECT * FROM hues where category='other' ORDER BY id DESC";
                ...
                if($page > 1)
                {
                    echo "<a class='a' href='other.php?page=1'>First</a>";
                    echo "<a class='a' href='other.php?page=".($page - 1)."'>Previous</a>";
                }
                for($i=$start_loop; $i<=$end_loop && $page > 1; $i++)
                {     
                    echo "<a class='a' href='other.php?page=".$i."'>".$i."</a>";
                }
                if($page < $end_loop)
                {
                    echo "<a class='a' href='other.php?page=".($page + 1)."'>Next</a>";
                    echo "<a class='a' href='other.php?page=".$total_pages."'>Last</a>";
                }
            ?>
        </div>
    </div>
