    ...
    if($con)
    {
        ...
        if(isset($_POST['submit']))
        {
            if(!empty($_POST['fname']) && !empty($_POST['mname']) && !empty($_POST['lname']) && !empty($_POST['email']) && !empty($_POST['dob']) && !empty($_POST['address']) && !empty($_POST['pass'])  && !empty($_POST['cpass']) &&($_POST['pass']==$_POST['pass']))
            {
                ...
                $query = "INSERT INTO seller(sellerFName,sellerMName,sellerLName,email,sdateOfBirth,saddress,MobileNo,password) values('$fname','$mname','$lname','$email','$dob','$add','$mob','$pass')";
...
<div class="msg" style="margin:.5vw 0;height:.5vw;font-weight:bold;"><p style="color:red; text-align:center;"><?php echo $msg; ?></p></div>
    <div class="main">
        <div class="left">
            <div class="up">
                <h4 style="text-align:center;">SELLER<br>REGISTRATION</h4><hr style="margin-top:1vh;">
            ...
            <form class="form"action="" class="form" method="POST">
                ...
                <div class="upright">
                    <ul>
                        ...
                        <li class="transfer"><a href="login.php"><p Style="font-size:1vw;">Existing Seller? Log in</p></a></li>
                    </ul>
                </div>
            </form>
        </div>
